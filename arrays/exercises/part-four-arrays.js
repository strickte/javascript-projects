...
console.log(holdCabinet1);
console.log(holdCabinet2);
//The reverse method acts as the name suggests, reversing the order of the array.
//The sort method sorts numerically (though not by value per se), then upper, then lower case alphabetically. 